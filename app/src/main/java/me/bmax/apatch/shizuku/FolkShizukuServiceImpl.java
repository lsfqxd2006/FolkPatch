...
public class FolkShizukuServiceImpl extends IShizukuService.Stub {

    private static final String TAG = "FolkShizukuService";
    static final int BINDER_TRANSACTION_transact = 1;
    static final String BINDER_DESCRIPTOR = "moe.shizuku.server.IShizukuService";
    static final int SERVER_VERSION = 13;
    ...
    FolkShizukuServiceImpl(int uid) {
        this.serverUid = uid;
        this.serverContext = getSelinuxContext();
    }
    ...
    public void attachApplication(IShizukuApplication application, Bundle args) {
        ...
        try {
            ...
            reply.putInt("shizuku:attach-reply-uid", serverUid);
            reply.putInt("shizuku:attach-reply-version", SERVER_VERSION);
            reply.putInt("shizuku:attach-reply-patch-version", 6);
            reply.putString("shizuku:attach-reply-secontext", serverContext);
