#!/usr/bin/env bash
# =============================================================================
# FolkPatch Release Build Script (Linux)
# Mirrors Build-Release.bat functionality for Linux / WSL environment
# =============================================================================
...
echo -e "${BLUE}[4/4]${NC} Executing ./gradlew assembleRelease..."
if ! ./gradlew assembleRelease; then
    echo -e "${RED}Error: ./gradlew assembleRelease execution failed!${NC}" >&2
    exit 1
fi
